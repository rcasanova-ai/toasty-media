...
export class LiveSession {
  constructor() {
    ...
    this.aiProducerService = new AIProducerService({
      ...
      provider: createAIProducerProvider({ useBackend: this.aiUseBackend, getOrganizationId: () => this.durableSession?.organizationId || null, getSessionId: () => this.durableSession?.id || null })
    });
  ...
  setAiUseBackend(useBackend) {
    ...
    this.aiProducerService.provider = createAIProducerProvider({ useBackend, getOrganizationId: () => this.durableSession?.organizationId || null, getSessionId: () => this.durableSession?.id || null });
