...
export const BRAND_THEMES = Object.freeze({
  toasty: Object.freeze({
    ...
    vars: Object.freeze({
      "--studio-canvas":"#0b0908","--studio-canvas-2":"#0f0b0a","--studio-surface":"#171210","--studio-surface-2":"#201815","--studio-surface-raised":"#2a201a","--studio-line":"rgba(230, 200, 168, 0.1)","--studio-line-strong":"rgba(255, 170, 110, 0.28)","--studio-line-warm":"rgba(184, 70, 14, 0.35)","--studio-cream":"#f4ead9","--studio-cream-dim":"#d3c2ac","--studio-muted":"#9c8d7c","--studio-orange":"#ff7a29","--studio-orange-bright":"#ffab5c","--studio-amber":"#ffc670","--studio-burnt":"#c1470f","--studio-brown":"#4a2d2a","--studio-green":"#34c77b","--studio-client-glow":"rgba(255, 122, 41, 0.24)"
    })
  }),
  workspace: Object.freeze({
    id: "workspace", label: "Workspace brand", showPoweredBy: true, logoSrc: null,
    logoAlt: "Workspace Studio", textLogo: "Workspace Studio", atmosphereBrand: "YOUR", atmosphereProduct: "STUDIO",
    vars: Object.freeze({
      "--studio-canvas":"#0a0d12","--studio-canvas-2":"#10141b","--studio-surface":"#151a22","--studio-surface-2":"#1c232d","--studio-surface-raised":"#252d39","--studio-line":"rgba(255,255,255,0.10)","--studio-line-strong":"rgba(255,255,255,0.24)","--studio-line-warm":"rgba(214,180,109,0.28)","--studio-cream":"#f5f1e8","--studio-cream-dim":"#d8d3ca","--studio-muted":"#98a1ad","--studio-orange":"#d6b46d","--studio-orange-bright":"#efd28e","--studio-amber":"#f5e7bd","--studio-burnt":"#9b7a3b","--studio-brown":"#20252d","--studio-green":"#5ec58b","--studio-client-glow":"rgba(214,180,109,0.24)"
    })
  })
});
...
if (typeof document !== "undefined") {
  document.querySelectorAll("#brandThemeSelect, #aiBrandProfile").forEach((select)=>{select.innerHTML='<option value="toasty">Toasty Media</option><option value="workspace">Workspace brand</option>';});
