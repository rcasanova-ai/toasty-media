// Explicit Host lifecycle states — the single source of truth for what Leave Studio, Talk to Hottie, the
// Join button, and the prejoin status text should show. Before this existed, none of those controls were
// gated on anything real: Leave Studio and Talk to Hottie were just always-visible/always-enabled markup
...
export const HostState = Object.freeze({
  ...
  IN_STUDIO: "in-studio",             // native video visible, VDO transport hidden, Talk to Hottie live
