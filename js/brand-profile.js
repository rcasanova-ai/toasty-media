...
const DEFAULT_PROFILES = Object.freeze({
  ...
  "8alta": Object.freeze({
    ...
    compactMark: "https://www.8alta.com/favicon.ico",
    watermark: true,
  ...
  santati: Object.freeze({
    ...
    compactMark: "https://www.santaticrm.com/assets/favicon-leaves.png",
    watermark: true,
  ...
  optimai: Object.freeze({
    ...
    compactMark: "https://optimai.network/favicon.ico",
    watermark: true,
  ...
  tangem: Object.freeze({
    ...
    logos: [],
    compactMark: "https://tangem.com/favicon.ico",
    watermark: true,
  ...
  superteam: Object.freeze({
    ...
    description: "Premium Bangkok/Web3 production for Superteam Thailand builders — navy studio, Thai identity in the details.",
    creatorName: "Superteam Thailand",
    creatorTitle: "Solana Builders · APAC",
    logos: ["../shared/brand/clients/superteam-thailand/logo.png"],
    compactMark: "../shared/brand/clients/superteam-thailand/logo.png",
    environmentalMotif: "../shared/brand/clients/superteam-thailand/silhouette-skyline.png",
    broadcastWatermark: "../shared/brand/clients/superteam-thailand/watermark-elephant.png",
    watermark: true,
    ...
    accentColor: "#c41e5a",
    supportingPalette: ["#050814", "#0b1328", "#a51931", "#2d2a6a", "#14f195", "#f4f7fc"],
    backgroundPreference: "deep navy production environment with magenta atmosphere, Thai red/white/blue detail, and restrained Solana green",
    fontDirection: "clean technical Inter headlines and compact professional body text",
    visualStyle: "premium Bangkok/Web3 studio: navy structure, magenta bloom, Thai flag details, elephant watermark, temple skyline, no purple wash",
    toneOfVoice: "energetic, technical, credible, community-first",
    writingStyle: "short declarative builder language, concrete, no hype",
    captionStyle: "high-contrast captions with a Thai-red or silver accent",
    lowerThirdStyle: "navy glass lower thirds with a Thai flag accent bar",
    introStyle: "open on navy depth with the Superteam Thailand mark centered",
    outroStyle: "close on the mark, a flag-bar settle, and one way to build together",
    ...
    thumbnailDirection: "navy field, white Superteam mark, one Thai-red or silver signal",
    forbiddenStyles: ["purple UI wash", "temple tourist kitsch", "generic coin rain", "hype language", "AI voiceover"],
    ...
    notes: "Thai identity lives in layered details: flag bars, elephant watermark, skyline silhouette. Keep artwork behind controls.",
    conciergePrefix: "Superteam Thailand Studio suggests:"
  }),
  peeps: Object.freeze({
    id: "peeps",
    name: "Toasty Peeps",
    description: "Bright, warm expert-conversation production for people, expertise, conversations, opportunities, and collaboration.",
    creatorName: "Toasty Peeps",
    creatorTitle: "Human Expertise Network",
    logos: ["../shared/brand/toasty-peeps/logo.png"],
    compactMark: "../shared/brand/toasty-peeps/logo.png",
    broadcastWatermark: "../shared/brand/toasty-peeps/watermark-mascot.png",
    watermark: true,
    defaultCTA: "Find the people. Keep the conversation.",
    website: "toasty.media",
    lowerThird: "Toasty Peeps · Human Expertise",
    primaryColor: "#ff7a29",
    secondaryColor: "#ffc53d",
    accentColor: "#e85a12",
    supportingPalette: ["#fbf6ee", "#fff9f1", "#3d2415", "#ffc53d", "#ff7a29"],
    backgroundPreference: "warm cream production environment with Toasty orange, flame yellow, and dark chocolate type",
    fontDirection: "bold Montserrat headlines with readable Inter body text",
    visualStyle: "bright people-first studio: cream surfaces, orange/flame energy, mascot watermark, friendlier cards, not a dark Toasty clone",
    ...
    lowerThirdStyle: "warm dark-chocolate lower thirds with an orange-to-flame accent bar",
    ...
    thumbnailDirection: "bold face, warm cream and orange contrast, 3-5 words max",
    forbiddenStyles: ["dark Toasty clone", "generic robot visuals", "cold SaaS gradients", "dense text slides", "AI voiceover"],
    preferredPhrases: ["people", "expertise", "conversations", "opportunities", "collaboration", "find the people", "keep the conversation"],
    ...
    notes: "Toasty Studio produces media. Toasty Peeps skins that same production system with people-first warmth. Do not invent Peeps product surfaces inside Studio.",
...
function profileFromTheme(theme) {
  return {
    ...
    compactMark: theme.compactMark || theme.faviconSrc || "",
    environmentalMotif: theme.artwork?.backgroundSilhouette || "",
    broadcastWatermark: theme.artwork?.backgroundWatermark || "",
    primaryColor: theme.vars["--brand-primary"],
    secondaryColor: theme.vars["--brand-secondary"],
    accentColor: theme.vars["--brand-accent"],
    backgroundWatermark: theme.artwork?.backgroundWatermark || "",
    backgroundSilhouette: theme.artwork?.backgroundSilhouette || "",
    backgroundArtwork: theme.artwork?.backgroundArtwork || "",
    brandPattern: theme.artwork?.brandPattern || "",
    surfaceGradient: theme.artwork?.surfaceGradient || "",
    accentGradient: theme.artwork?.accentGradient || theme.vars["--brand-gradient"],
    decorativeOpacity: theme.artwork?.decorativeOpacity ?? 0,
    logoTreatment: theme.artwork?.logoTreatment || "",
    lowerThirdTreatment: theme.artwork?.lowerThirdTreatment || "",
    titleCardTreatment: theme.artwork?.titleCardTreatment || "",
    introTreatment: theme.artwork?.introTreatment || "",
    outroTreatment: theme.artwork?.outroTreatment || "",
